...
let mainProjName = "FulmaExtensions"
...
Target.create "Meta" (fun _ ->
    ...
    [
        ...
        "    <PackageProjectUrl>https://github.com/gretmn102/FulmaExtensions</PackageProjectUrl>"
        "    <PackageLicenseExpression>MIT</PackageLicenseExpression>"
        "    <RepositoryUrl>https://github.com/gretmn102/FulmaExtensions.git</RepositoryUrl>"
        sprintf "    <PackageReleaseNotes>%s</PackageReleaseNotes>"
            (String.concat "\n" release.Notes |> XmlText.escape)
        "    <PackageTags>bulma;fsharp;fable</PackageTags>"
